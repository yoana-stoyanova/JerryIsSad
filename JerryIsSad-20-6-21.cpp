...
int main ()
{
    ...
    int flowermat1=rand()%3+3, catmat1=rand()%3+3, toymat1=rand()%5+3;
    int flowermat2=flowermat1, catmat2=catmat1, toymat2=toymat1;
    int flowerhint=0, cathint=0, toyhint=0;
    int materials=flowermat1+catmat1+toymat1;
